...
const SocialLinks = () => {
  const socialIcons = [
    {
      href: "https://github.com/justoo67",
    ...
    {
      href: "https://instagram.com/76._justin",
    ...
    <>
      <div class="hidden md:block">
        ...
        <div className="fixed right-8 bottom-0 flex flex-col gap-18 items-center">
          <a href="mailto:636justin@gmail.com" className=" transform rotate-90 text-slate-400 hover:text-[#1F7D53] transition-colors ">636justin@gmail.com</a>
